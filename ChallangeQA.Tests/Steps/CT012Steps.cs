...
// Avançar sem preencher apenas o campo cidade
namespace ChallangeQA.Steps
{
    [Binding]
    public class CT012Steps
    {
        ...
        public void GivenQueOsDadosDasEtapasAnterioresTenhamSidoCorretamenteInseridas()
        {
        ...
        public void WhenTenhaPreenchidoOsCamposObrigatoriosDoFormularioDeCadastroExcetoCidade()
        {
        ...
        public void ThenAoAvancarSemInformarOCidadeUmAlertaDeveSerExibidoCampoObrigatorio()
        {
