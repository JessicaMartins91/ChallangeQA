...
namespace ChallangeQA.Steps
{
    ...
    public class CT011Steps
    {
        ...
        public void GivenQueOsDadosDasEtapasAnterioresTenhamSidoPreenchidosCorretamente()
        {
        ...
        public void WhenTenhaPreenchidoOsCamposObrigatoriosDoFormularioDeCadastroExcetoBairro()
        {
        ...
        public void ThenAoAvancarSemInformarOBairroUmAlertaDeveSerExibidoCampoObrigatorio()
        {
