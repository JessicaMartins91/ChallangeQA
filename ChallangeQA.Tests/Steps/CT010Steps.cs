...
// Avançar sem preencher apenas o campo endereço
namespace ChallangeQA.Steps
{
    [Binding]
    public class CT010Steps
    {
        ...
        public void GivenQueOsDadosDasEtapasAnterioresTenhamSidoInformados()
        {
        ...
        public void WhenTenhaPreenchidoOsCamposObrigatoriosDoFormularioDeCadastroExcetoEndereco()
        {
        ...
        public void ThenAoAvancarSemInformarOCampoEnderecoUmAlertaDeveSerExibidoCampoObrigatorio()
        {
