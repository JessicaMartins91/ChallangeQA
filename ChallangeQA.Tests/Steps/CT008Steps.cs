...
// Avançar sem preencher apenas o campo celular
namespace ChallangeQA.Steps
{
    [Binding]
    public class CT008Steps
    {
        ...
        public void GivenQueOUsuarioTenhaInformadoAsEtapasAnteriores()
        {
        ...
        public void WhenTenhaPreenchidoOsCamposObrigatoriosExcetoCelular()
        {
        ...
        public void ThenAoAvancarSemInformarOCampoCelularUmAlertaDeveSerExibidoCampoObrigatorio()
        {
