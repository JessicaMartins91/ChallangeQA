...
namespace ChallangeQA.Steps
{
    ...
    public class CT019Steps
    {
        ...
        public void GivenQueOUsuarioFoiDirecionadoATelaDeCadastroEOsDadosForamInformados()
        {
        ...
        public void WhenOUsuarioPreencheOCampoCelularComMaisDe15Caracteres()
        {
            ...
            celularInput.SendKeys("3197500000001520"); // Mais de 15 caracteres
         ...
         public void ThenUmaMensagemDeAlertaDeveSerExibidaInformandoSobreAQuantidadeMaximaPermitida()
        {
            ...
            var alertaCelular = wait.Until(d =>
                d.FindElement(By.XPath("//p[@role='alert' and contains(text(), 'Devem ser informados no máximo 15 caracteres')]"))
            );
            alertaCelular.Text.Should().Contain("Devem ser informados no máximo 15 caracteres");
        }
