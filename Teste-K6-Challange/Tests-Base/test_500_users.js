...
export function handleSummary(data) {
  return {
    'resultados/summary-500.json': JSON.stringify(data, null, 2),
    'resultados/summary-500.html': `
      <html>
        <head>
          <title>Relatório de Performance - 500 usuários</title>
        </head>
        <body>
          <h1>Resumo do Teste com 500 Usuários</h1>
